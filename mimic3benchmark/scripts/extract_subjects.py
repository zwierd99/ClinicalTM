...
parser.add_argument('--mimic3_path', type=str, default="data/MIMIC", help='Directory containing MIMIC-III CSV files.')
parser.add_argument('--output_path', type=str, default='data/root', help='Directory where per-subject data should be written.')
...
# args.mimic3_path = "data/MIMIC"
# args.output_path = 'data/root'
